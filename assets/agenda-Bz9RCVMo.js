...
Os eventos serão distribuídos de segunda a sexta-feira ao longo do ano.`)){console.log("Importação cancelada.");return}try{const e=await Z(window.calendar);await window.calendar.showAlert("Importação Concluída",`✅ Importação concluída!
